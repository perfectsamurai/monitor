                ...
                <div className={styles.createBlock}>
                    ...
                    <div className={styles.createLab}>
                        ...
                        <select>
                            ...
                            <option selected value="">АН</option>
                        ...
                        <select>
                            <option value="">Выберите из списка</option>
                            <option selected value="">49</option>
                        ...
                        <select>
                            <option value="">Выберите из списка</option>
                            <option selected value="">Исследование до КРС</option>
                    ...
                    <div className={styles.createButton}>
                        <div className={styles.inputButton3}>
                            <input onClick={props.onClose} type="button" value='Отмена'/>
                        </div>
